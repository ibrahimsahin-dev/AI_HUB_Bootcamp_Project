...
print("\tKarakterlerin savaşırken kullandığı silahlar ve canları vardır.\n")
print("\tKarakterlerin herhangi birinin canı bittiğinde oyun sona erer.\n")
print("\tKarakterler ve vuruş önceliği taş kağıt makas oyunuyla belirlenir.\n")
print("\tOyuncular taş kağıt makas oyunu oynayarak karakterleri belirler.\n")
...
while (i):
    ...
    kazanan = 0
    secim_oyun = input(
        "Taş kağıt makas oyununu oynamak için 'Taş', 'Kağıt' veya 'Makas'dan "
        "1'ini seçiniz:"
    )
